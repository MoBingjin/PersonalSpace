<template>
  <div>
    <el-menu :collapse="isCollapse" :collapse-transition="false" active-text-color="#ffd04b" background-color="#545c64"
      ...
      <el-menu-item index="1" @click="openTab('首页', 'mo-main', {})">
        <el-icon>
          <e-icon icon-name="el-icon-s-home" />
        </el-icon>
        <span>首页</span>
      </el-menu-item>
      <el-menu-item index="2" @click="openTab('发布文章', 'mo-publish-article', {})">
        <el-icon>
      ...
      <el-sub-menu index="3">
        ...
        <el-menu-item index="3-1" @click="openTab('文章管理', 'content-management/mo-article-management', {})">
